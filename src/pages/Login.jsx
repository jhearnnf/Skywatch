...
// Three views within the login page
const VIEW = { CHOICE: 'choice', SIGNIN: 'signin', REGISTER: 'register' }
...
function ShieldLarge() {
  return (
    <svg className="login-brand-icon" width="52" height="60" viewBox="0 0 52 60" fill="none" aria-hidden="true">
      {/* Outer shield */}
      <path
        d="M26 2L3 11v18c0 14.5 10 27.5 23 30.5C39 56.5 49 43.5 49 29V11L26 2z"
        stroke="currentColor" strokeWidth="2.5" strokeLinejoin="round"
      />
      {/* Inner border */}
      <path
        d="M26 9L10 16.5v12.5c0 10.5 7 20 16 24 9-4 16-13.5 16-24V16.5L26 9z"
        stroke="currentColor" strokeWidth="1" strokeLinejoin="round" opacity="0.3"
      />
      {/* Targeting circle */}
  ...
  return (
    <div className="login-page">
      <div className="login-card">
        ...
        {view === VIEW.CHOICE && (
          <>
            ...
            <div className="login-options">
              <button className="login-opt-btn" onClick={() => reset(VIEW.REGISTER)}>
                Create Account
              </button>
              <button className="login-opt-btn login-opt-btn--primary" onClick={() => reset(VIEW.SIGNIN)}>
                Sign In with Email
              </button>
        ...
        {/* ── Sign in / Register shared form ────────────── */}
        {(view === VIEW.SIGNIN || view === VIEW.REGISTER) && (
          <>
            <div className="login-header">
              <p className="login-eyebrow">🛡 Agent Login</p>
              <h2 className="login-title">
                {view === VIEW.SIGNIN ? 'Sign In' : 'Create Account'}
              </h2>
            </div>
