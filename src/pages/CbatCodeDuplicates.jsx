...
export default function CbatCodeDuplicates() {
  ...
  const handleNext = () => advance(roundResults)
  ...
  const testBar = inRound ? {
    ...
    total: TOTAL_ROUNDS,
    timeFrac: null,
    progressFrac: (round - 1) / TOTAL_ROUNDS,
  } : null
          ...
          {phase === 'intro' && (
            ...
            >
              ...
              <div className="text-center mb-4">
                <Link to="/cbat/code-duplicates/leaderboard" className="text-xs lg:text-sm text-brand-600 hover:text-brand-700 transition-colors">
                  View Leaderboard →
                </Link>
              </div>
