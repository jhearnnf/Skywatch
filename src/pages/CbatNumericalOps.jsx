...
export default function CbatNumericalOps() {
  ...
  function recordAnswer(pickedRaw, elapsedMs) {
    ...
    // a sum moves straight on to the next.
    if (cbat) {
      goNext()
      return
    }
  ...
  useEffect(() => {
    ...
    const t = setTimeout(() => startGameRef.current(), NUMERICAL_OPS_LAUNCH_MS)
        ...
        <div className="flex flex-col items-center">
          ...
          {(phase === 'intro' || launching) && (
            ...
            >
              ...
              <p className={`text-xl lg:text-2xl font-extrabold text-white mb-2${dim}`}>Numerical Operations</p>
              <CbatModeRow
                modes={NUMERICAL_OPS_DIFFICULTIES}
                value={difficulty}
