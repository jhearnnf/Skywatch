...
vi.mock('../../components/AircraftTopDown', () => ({ default: () => null, preloadModel: () => {} }))
...
const BRIEF_ID = 'b1'
const MOCK_AIRCRAFT = [{ briefId: BRIEF_ID, title: 'Eurofighter Typhoon FGR4', cutoutUrl: 'http://example.com/typhoon.png' }]
