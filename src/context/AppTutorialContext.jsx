...
export const TUTORIAL_STEPS = {
  ...
  profile: [
    ...
    { emoji: '📊', title: 'Overview Tab',
      body: 'The Overview tab shows briefs read, games played, average recall score, total Airstars and your Selection Readiness. Tap any stat to see its history.' },
    { emoji: '🏆', title: 'Ranks Tab',
      body: 'Switch to the Ranks tab to see how you rank against other learners by total Airstars.' },
