  ...
  return (
    <AnimatePresence>
      <motion.div
        ...
        aria-live="polite"
        className="fixed top-4 left-1/2 -translate-x-1/2 z-[200] flex items-center gap-3 bg-brand-200 text-slate-900 px-5 py-3 rounded-2xl shadow-xl shadow-brand-300/50 font-bold text-sm whitespace-nowrap"
      >
        <motion.span
