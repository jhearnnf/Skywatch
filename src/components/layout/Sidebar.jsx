...
export default function Sidebar() {
  ...
  return (
    <aside className="hidden md:flex flex-col fixed left-0 top-14 bottom-0 w-56 bg-white border-r border-slate-200 z-30">
      {/* Nav items */}
      ...
      {user && levelInfo && (
        <div className="border-t border-slate-200 p-4">
          <div className="flex items-center gap-2 mb-2">
            <div className="w-8 h-8 rounded-full bg-brand-100 border-2 border-brand-200 flex items-center justify-center text-sm font-bold text-brand-700">
