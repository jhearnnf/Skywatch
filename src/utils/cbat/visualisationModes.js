...
// in the first and rotate a solid in the second — so neither carries bars, and
// the name is just the dimension: the pill reads 2D or 3D and nothing else.
...
export const VISUALISATION_MODES = [
  { key: '2d', label: '2D', gameKey: 'visualisation-2d', blurb: 'Weld flat shapes together and spot the match' },
  { key: '3d', label: '3D', gameKey: 'visualisation-3d', blurb: 'Rotate a 3D composite and spot the match' },
]
