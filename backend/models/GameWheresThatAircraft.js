...
const gameWheresThatAircraftSchema = new mongoose.Schema({
...
gameWheresThatAircraftSchema.pre('save', async function () {
...
module.exports = mongoose.model('GameWheresThatAircraft', gameWheresThatAircraftSchema);
