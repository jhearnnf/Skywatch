...
const appSettingsSchema = new mongoose.Schema({
  ...
  cbatGameEnabled: {
    ...
    default: () => ({
      ...
      angles: true, instruments: true, 'instruments-orientation': true, 'instruments-practise': true,
      'plane-turn-2d': true, 'plane-turn-3d': true, 'trace-1': true, 'trace-2': true,
      flag: true, 'flag-easier': true, clan: true, 'clan-easier': true,
      'visualisation-2d': true, 'visualisation-3d': true,
      dpt: true, 'dpt-hard': true, 'dpt-easier': true, act: true,
      'numerical-ops': true, 'numerical-ops-easier': true,
      dad: true,
      sat: true, 'sat-easier': true,
      cut: true, 'cut-easier': true,
      rtt: true, 'rtt-easier': true,
      sit: true, 'sit-easier': true,
      slt: true, 'slt-easier': true,
      vlt: true, 'vlt-easier': true,
      matf: true, 'matf-easier': true,
      vigilance: true, 'vigilance-hard': true, 'vigilance-practise': true,
