...
async function seedBriefs() {
  ...
  const briefs = [
...

    {
      ...
      status: 'published',
      descriptionSections: [
        `Royal Air Force Typhoon FGR4 aircraft were scrambled from RAF Lossiemouth on Quick Reaction Alert duty after two Russian Tupolev Tu-95 Bear strategic bombers were detected approaching UK airspace over the North Sea. The aircraft, from No. 6 Squadron, intercepted the bombers approximately 40 nautical miles from the UK Air Defence Identification Zone and shadowed them for ninety minutes before the Russian aircraft turned back toward international airspace.`,
        `This marks the third such intercept this year, continuing a pattern of Russian long-range aviation probing NATO member defences. Wing Commander Sarah Hutchings stated the response was executed flawlessly and serves as a reminder of the RAF's commitment to protecting sovereign airspace.`,
        `The incident was coordinated with NATO's Combined Air Operations Centre and monitored by the E-3D Sentry orbiting over the North Sea. No hostile intent was assessed by intelligence analysts following the intercept.`,
        `RAF Typhoons from Lossiemouth intercepted two Russian Tu-95 Bear bombers near UK airspace over the North Sea, shadowing them for ninety minutes before they turned back.`,
      ],
...

    {
      ...
      status: 'published',
      descriptionSections: [
        `No. 617 Squadron "The Dambusters" has been formally declared at Initial Operating Capability with the F-35B Lightning stealth multirole aircraft following a rigorous work-up programme at RAF Marham in Norfolk. The declaration was made by Air Officer Commanding 1 Group during a ceremony attended by senior RAF leadership and defence industry partners.`,
        `IOC confirms the squadron can generate, deploy, and sustain a minimum combat-capable force across a range of operational scenarios. The Lightning's advanced sensors, stealth characteristics, and networked data-sharing represent a significant leap in RAF offensive capability.`,
        `The F-35B variant is specifically configured for Short Take-Off and Vertical Landing, enabling operations from both land bases and the Queen Elizabeth-class aircraft carriers HMS Queen Elizabeth and HMS Prince of Wales. Follow-on training exercises are planned with US Marine Corps F-35B units later this year to consolidate interoperability procedures.`,
        `No. 617 Squadron declared IOC with the F-35B Lightning at RAF Marham, confirming the squadron can deploy a combat-capable stealth force from land and carrier.`,
      ],
...

    {
      ...
      status: 'published',
      descriptionSections: [
        `RAF Typhoon FGR4 aircraft, supported by an A330 Voyager tanker, have completed Exercise ATLANTIC STRIKE — a demanding long-range strike training mission designed to validate the UK's ability to project air power at strategic distances.`,
        ...
        `Four RAF Typhoons completed a ten-hour long-range strike exercise over the Atlantic, supported by Voyager tanker refuelling, validating UK strategic air power projection.`,
      ],
...

    {
      ...
      status: 'published',
      descriptionSections: [
        `The Eurofighter Typhoon FGR4 is the Royal Air Force's principal multi-role combat aircraft, forming the backbone of both UK air defence and offensive air power. Developed through a multinational European consortium and entering RAF service in 2003, the Typhoon is a highly agile, supersonic, canard-delta wing fighter capable of exceeding Mach 2.`,
        `The FGR4 variant is the definitive RAF configuration, equipped with the CAPTOR-E AESA radar, the PIRATE infrared search and track sensor, and a comprehensive defensive aids suite. Its weapons payload includes ASRAAM, Meteor, AMRAAM, Brimstone, Storm Shadow, and Paveway IV, giving it formidable beyond-visual-range air combat, close-in air combat, and precision strike capability.`,
        `The aircraft operates from RAF Lossiemouth, RAF Coningsby, and RAF Akrotiri, and provides QRA cover for the UK and Falkland Islands. With the introduction of the F-35B, the Typhoon's role is evolving toward electronic warfare and deep strike missions, extending its operational life well into the 2040s.`,
        `The Typhoon FGR4 is the RAF's primary multi-role fighter, operating from Lossiemouth, Coningsby, and Akrotiri for air defence and precision strike.`,
      ],
...

    {
      ...
      status: 'published',
      descriptionSections: [
        `The Boeing RC-135W Rivet Joint is the Royal Air Force's strategic signals intelligence aircraft, operated by No. 51 Squadron from RAF Waddington. The aircraft is a highly modified C-135 variant packed with sophisticated ELINT and COMINT collection systems capable of detecting, locating, and analysing electromagnetic emissions across an extremely wide spectrum.`,
        `The RAF operates three Rivet Joints, which replaced the Nimrod R1 fleet following the 2010 Strategic Defence and Security Review. The aircraft provides persistent Intelligence, Surveillance, and Reconnaissance capability, typically orbiting at high altitude for many hours over an area of interest and feeding intelligence data to analysts both on board and at ground exploitation cells.`,
        `The RC-135W has been deployed on operations over Iraq, Syria, Ukraine, and the broader Euro-Atlantic area. Its intelligence product supports targeting, force protection, and national intelligence assessments at the highest levels of command. The aircraft operates closely with GCHQ and allied partners to fuse signals intelligence across multiple collection platforms.`,
        `The RC-135W Rivet Joint is the RAF's strategic SIGINT aircraft, operated by 51 Squadron from Waddington, providing persistent ISR across multiple theatres.`,
      ],
...

    {
      ...
      status: 'published',
      descriptionSections: [
        `RAF Lossiemouth, situated on the Moray Firth coast of north-east Scotland, is the RAF's most northerly frontline operating base and serves as the headquarters of Air Command's northern air defence mission. The station is home to four Typhoon FGR4 squadrons — Nos. 1(F), 6, 11(F), and 2 OCU — as well as No. 120 Squadron operating the P-8A Poseidon maritime patrol aircraft.`,
        `Lossiemouth hosts the northern Quick Reaction Alert commitment, maintaining Typhoons at two minutes' readiness around the clock to intercept aircraft approaching UK airspace from the north and north-west. Its location provides significant geographic advantage for monitoring the Norwegian Sea, the GIUK gap, and Arctic approaches.`,
        `The base has undergone extensive infrastructure investment under Project MARSHAL, including new hardened aircraft shelters, upgraded fuel systems, and enhanced electronic warfare training ranges. RAF Lossiemouth also supports Exercise JOINT WARRIOR, a twice-yearly multinational exercise drawing maritime, air, and land forces from across NATO.`,
        `RAF Lossiemouth is the RAF's most northerly frontline base, hosting four Typhoon squadrons and P-8A Poseidon, and providing QRA cover for northern UK airspace.`,
      ],
...

    {
      ...
      status: 'published',
      descriptionSections: [
        `RAF Akrotiri forms part of the United Kingdom's Sovereign Base Areas in Cyprus, retained after Cypriot independence in 1960. Located on the southern tip of Cyprus near Limassol, Akrotiri provides the UK with an enduring strategic footprint in the Eastern Mediterranean — approximately 240 kilometres from the Syrian coast.`,
        `The base has supported nearly continuous combat operations since the first Gulf War, including Operation SHADER — the UK's contribution to the counter-ISIL campaign in Iraq and Syria. The station's geographic position enables rapid power projection into the Middle East, North Africa, and the Caucasus.`,
        `Akrotiri maintains robust force protection measures including live-fire ranges and an integrated air defence system. It also serves an important humanitarian role, coordinating evacuation operations across the region and hosting disaster relief deployments. The station regularly hosts Typhoon, Sentinel, and Rivet Joint deployments and serves as a forward operating location for coalition air operations.`,
        `RAF Akrotiri is a UK Sovereign Base in Cyprus providing a strategic hub for Eastern Mediterranean operations, supporting combat, ISR, and humanitarian missions.`,
      ],
...

    {
      ...
      status: 'published',
      descriptionSections: [
        `RAF Brize Norton in Oxfordshire is the largest Royal Air Force station by personnel and one of the most operationally significant bases in the UK. It serves as the home of strategic air transport and air-to-air refuelling, operating the A400M Atlas airlifter and the A330 Voyager tanker transport.`,
        `Brize Norton is the operational home of No. 10 and No. 101 Squadrons on Voyager, No. 99 Squadron on C-17 Globemaster III, and multiple A400M Atlas squadrons. As the gateway for UK strategic airlift, Brize Norton supports the full spectrum of operational commitments — from non-combatant evacuation operations to humanitarian aid delivery and the continuous air bridge to the Falkland Islands.`,
        `The Voyager fleet provides the RAF's air-to-air refuelling capability, enabling the extended range of Typhoon on long-range operations. The base also houses the Air Mobility Force and provides joint personnel recovery and parachute training facilities for UK and allied forces.`,
        `RAF Brize Norton is the RAF's largest station, home to strategic airlift and tanker fleets including Voyager, C-17, and A400M Atlas.`,
      ],
...

    {
      ...
      status: 'published',
      descriptionSections: [
        `The Boeing E-7 Wedgetail is the Royal Air Force's incoming Airborne Early Warning and Control System, selected to replace the ageing E-3D Sentry following the type's retirement in 2021. Based on the Boeing 737-700 airframe, the E-7 is equipped with the Multi-Role Electronically Scanned Array radar — a fixed dorsal antenna providing 360-degree coverage with significantly enhanced processing power and electronic counter-countermeasures resistance compared to the rotating rotodome on the E-3.`,
        `The MESA radar can simultaneously track hundreds of targets while controlling multiple intercepts in contested electromagnetic environments. The RAF has committed to three aircraft, with initial deliveries expected to enter service with No. 8 Squadron at RAF Lossiemouth.`,
        `The E-7 operates in close concert with the F-35B as the airborne node in a networked kill chain that fuses information from space, air, land, and maritime sensors. Australia's RAAF has operated the E-7 since 2009 with considerable operational success, providing the RAF with a mature development baseline.`,
        `The E-7 Wedgetail is the RAF's next-generation AEW&C platform, replacing the E-3D Sentry with advanced MESA radar and networked sensor fusion.`,
      ],
